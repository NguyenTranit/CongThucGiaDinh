...
public class ThucDonAdapter2 extends RecyclerView.Adapter<ThucDonAdapter2.ViewHolderCate> {
    Context context;
    List<ThucDonModel> thucDonModelList;


    public ThucDonAdapter2(Context context, List<ThucDonModel> thucDonModelList) {
    ...
    public ViewHolderCate onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new ViewHolderCate(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_thucdon2, parent, false));
    }
